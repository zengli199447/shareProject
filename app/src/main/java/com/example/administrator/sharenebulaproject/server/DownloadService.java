...
import com.example.administrator.sharenebulaproject.utils.IOUtils;
import com.example.administrator.sharenebulaproject.utils.InstallUtil;
import com.example.administrator.sharenebulaproject.widget.SystemManager;
...
public class DownloadService extends Service {
    ...
    public class DownloadBinder extends Binder {
        ...
        public long startDownload(String apkUrl) {
            //点击下载
            //删除原有的APK
            IOUtils.clearApk(DownloadService.this, new StringBuffer().append(getString(R.string.app_name)).append(".apk").toString());
            //使用DownLoadManager来下载
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(apkUrl));
            //将文件下载到自己的Download文件夹下,必须是External的
            //这是DownloadManager的限制
            File file = new File(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), new StringBuffer().append(getString(R.string.app_name)).append(".apk").toString());
