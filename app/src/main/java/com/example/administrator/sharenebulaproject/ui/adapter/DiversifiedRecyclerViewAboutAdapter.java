...
public class DiversifiedRecyclerViewAboutAdapter extends RecyclerView.Adapter<DiversifiedRecyclerViewAboutAdapter.ViewHolder> {
    ...
    public DiversifiedRecyclerViewAboutAdapter(Context context, List<Object> theArticleList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                view = LayoutInflater.from(context).inflate(R.layout.item_hot_page_type_1_off, parent, false);
                break;
            case 1:
                view = LayoutInflater.from(context).inflate(R.layout.item_hot_page_type_1_off, parent, false);
                break;
            case 2:
                view = LayoutInflater.from(context).inflate(R.layout.item_hot_page_type_1_on, parent, false);
                break;
            case 3:
                view = LayoutInflater.from(context).inflate(R.layout.item_hot_page_type_2_off, parent, false);
                break;
            case 4:
                view = LayoutInflater.from(context).inflate(R.layout.item_hot_page_type_2_on, parent, false);
                break;
            case 5:
                view = LayoutInflater.from(context).inflate(R.layout.item_hot_page_type_3_off, parent, false);
                break;
            case 6:
                view = LayoutInflater.from(context).inflate(R.layout.item_hot_page_type_3_on, parent, false);
                break;
            case 7:
                view = LayoutInflater.from(context).inflate(R.layout.layout_refresh_view, parent, false);
                break;
            case 8:
                view = LayoutInflater.from(context).inflate(R.layout.feed_h5_item_placement, null);
                break;
            case 9:
                view = LayoutInflater.from(context).inflate(R.layout.layout_self_built_advertising, parent, false);
                break;
            default:
...
//            });
            ...
            if (!newsBean.getSource().equals(holder.time_no.getText().toString()))
                holder.time_no.setText(newsBean.getSource());
            if (!new StringBuffer().append("阅读: ").append(newsBean.getAmount_read()).toString().equals(holder.amount_read_no.getText().toString()))
            ...
            if (newsBean.getIfcanmoney() == 1) {
                if (holder.starbean_no != null) {
                    String starText = new StringBuffer().append("奖励池: ").append(newsBean.getStarbean()).append("星豆").toString();
                    if (!starText.equals(holder.starbean_no.getText().toString()))
                        holder.starbean_no.setText(starText);
                }

                if (holder.shares_no != null) {
                    String sharesText = new StringBuffer().append("分享: ").append(newsBean.getAmount_share()).append("人").toString();
                    if (!sharesText.equals(holder.shares_no.getText().toString()))
                        holder.shares_no.setText(sharesText);
                }
