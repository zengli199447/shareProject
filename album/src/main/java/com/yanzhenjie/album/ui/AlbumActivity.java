...
import com.yanzhenjie.album.util.ImmersionUtils;
...
public class AlbumActivity extends CompatActivity implements AlbumCallback {
    ...
    private FragmentWaitReceiver receiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ImmersionUtils().setImmersionUtils(this,true);
        CameraReceiver();
    ...
    private void CameraReceiver() {
        intentFilter = new IntentFilter();
        intentFilter.addAction("com.broadcast.camera");
        receiver = new FragmentWaitReceiver();
        registerReceiver(receiver, intentFilter);
    }

    class FragmentWaitReceiver extends BroadcastReceiver {
        public FragmentWaitReceiver() {
        }

        @Override
        public void onReceive(Context context, final Intent intent) {
            String msg = intent.getStringExtra("CameraStatus");
            if (msg != null && msg.contains("finish")) {
                finish();
            }
        }
    }
